...
def test_petlib_present():
    """
    Check Petlib and pytest are imported
    """
    assert "petlib" in sys.modules
...
def test_code_present():
    """
    Check lab01 is imported
    """
    assert "lab01" in sys.modules
...
def test_key_gen():
    ...
    from lab01 import ecdsa_key_gen
    ecdsa_key_gen()
    assert True
...
def test_key_gen():
    ...
    assert pub == priv * group.generator()
